...
def excel():
    ...
    sheet.cell(row=1, column=8).value = "message"
...
def insert():
    ...
    if (name_field.get() == "" and
        ...
        sheet.cell(row=current_row + 1, column=8).value = message_field.get()
...
if __name__ == "__main__":
    ...
    # create a Form label
    heading = Label(root, text="Feedback Form", bg="light green")
    ...
    # create a address label
    message = Label(root, text="Message", bg="light green")
    ...
    message_field.grid(row=8, column=1, ipadx="100")
